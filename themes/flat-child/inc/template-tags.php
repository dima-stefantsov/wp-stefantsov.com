...
if ( ! function_exists( 'flat_entry_meta' ) ) :
	...
	function flat_entry_meta( $show_sep = true, $author_postbox = false ) {
		if ( true === $author_postbox ) {
			...
			printf( __( '<span class="entry-date"><time class="entry-date published" datetime="%2$s">%3$s</time></span> by <span class="author vcard"><span class="url fn n" href="%4$s" rel="author">%5$s</span></span>', 'flat' ),
			...
			/* translators: 1: Permalink, 2: Computer-friendly published date, 3: User-friendly published date, 4: Author archive link, 5: Author name */
			printf( __( '<span class="entry-date"><time class="entry-date published" datetime="%2$s">%3$s</time></a></span> by <span class="author vcard"><span class="url fn n" href="%4$s" rel="author"><span>%5$s</span></span>', 'flat' ),
				esc_url( get_permalink() ),
				esc_attr( get_the_date( 'c' ) ),
				esc_html( get_the_date() ),
				esc_url( get_author_posts_url( get_the_author_meta( 'ID' ) ) ),
